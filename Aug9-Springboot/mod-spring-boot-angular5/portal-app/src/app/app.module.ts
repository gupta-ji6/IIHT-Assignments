...
import {MatButtonModule, MatDatepickerModule, MatSliderModule, MatChipsModule,MatProgressBarModule,MatCheckboxModule, MatPaginatorModule,MatToolbarModule,MatInputModule,MatProgressSpinnerModule, MatCardModule,MatMenuModule, MatIconModule, MatSidenavModule, MatListModule, MatSelectModule, MatSortModule} from '@angular/material';
...
@NgModule({
  ...
  imports: [LayoutModule, MatDatepickerModule, MatSliderModule, MatChipsModule, MatProgressBarModule,BrowserModule, AppRoutingModule, HttpClientModule, FormsModule, MatPaginatorModule,ReactiveFormsModule,BrowserAnimationsModule,MatTableModule, MatSortModule, MatButtonModule,MatCheckboxModule,MatToolbarModule,MatInputModule,MatProgressSpinnerModule,MatCardModule,MatMenuModule, MatIconModule, MatSidenavModule, MatListModule, MatSelectModule],
