...
//			Session is expensive, so we use RequestDisaptcher. Also, using respone.sendRedirect user is able to see the redirect in url. in rd.forward, it's not visible.
